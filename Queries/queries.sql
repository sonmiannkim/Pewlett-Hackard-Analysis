...
SELECT * FROM salaries sal, employees emp
WHERE sal.emp_no = emp.emp_no
ORDER BY sal.to_date desc;


SELECT * FROM salaries ORDER BY to_date DESC;

--Creating employee's info table
SELECT e.emp_no,
    e.first_name,
	e.last_name,
    e.gender,
...
--Create table for the Sales and Development teams
